...
#
# 2026-09-09, bulk over-flattening pass (audit_overflatten.py): 38 of the pins
# below were rewritten in one go. They had frozen the *flattened* form of their
# kanji — 打 as 扌+亅 rather than 扌+丁, 禁 as 示+木 rather than 示+林, 貧 as 貝+刀
# rather than 貝+分 — so they were pinning the very bug the audit exists to
# remove. Freezing a wrong answer is worse than not pinning it: it turns the
...
EXPECTED_DECOMPOSITIONS = {
    ...
    "rtk705": {"character": "打", "keyword": "strike",
               "expected_part_ids": {"kangxi64", "rtk95"}},
    ...
    "rtk1892": {"character": "艶", "keyword": "glossy",
                "expected_part_ids": {"rtk1551", "rtk1890"}},
    ...
    "rtk2785": {"character": "鋲", "keyword": "rivet",
                "expected_part_ids": {"rtk287", "rtk1429"}},
    "rtk2795": {"character": "鋏", "keyword": "scissors",
                "expected_part_ids": {"rtk287", "rtk1023", "rtk112"}},
    ...
    "rtk1179": {"character": "禁", "keyword": "prohibition",
                "expected_part_ids": {"rtk1167", "rtk208"}},
    ...
    "rtk2843": {"character": "鴎", "keyword": "seagull",
                "expected_part_ids": {"rtk1831", "rtk2091"}},
    "rtk2844": {"character": "鵬", "keyword": "roc",
                "expected_part_ids": {"rtk19", "rtk2091"}},
    "rtk2845": {"character": "鸚", "keyword": "parakeet",
                "expected_part_ids": {"rtk2091", "rtk2307"}},
    "rtk2846": {"character": "鵡", "keyword": "parrot",
                "expected_part_ids": {"rtk2091", "rtk403"}},
    ...
    "rtk502": {"character": "乾", "keyword": "drought",
                "expected_part_ids": {"prim-mist", "rtk501"}},
    ...
    "rtk692": {"character": "議", "keyword": "deliberation",
                "expected_part_ids": {"rtk357", "rtk691"}},
    "rtk693": {"character": "犠", "keyword": "sacrifice",
                "expected_part_ids": {"rtk260", "rtk691"}},
    ...
    "rtk995": {"character": "糧", "keyword": "provisions",
                "expected_part_ids": {"rtk189", "rtk987"}},
    "rtk1021": {"character": "築", "keyword": "fabricate",
                "expected_part_ids": {"rtk207", "rtk2681"}},
    ...
    "rtk1156": {"character": "昼", "keyword": "daytime",
                "expected_part_ids": {"rtk1151", "rtk30"}},
    ...
    "rtk1634": {"character": "熱", "keyword": "heat",
                "expected_part_ids": {"prim-fire-radical", "prim-mini-tractor", "rtk44"}},
    ...
    "rtk2138": {"character": "駅", "keyword": "station",
                "expected_part_ids": {"rtk1151", "rtk2132"}},
    ...
    "rtk441": {"character": "柿", "keyword": "persimmon",
                "expected_part_ids": {"rtk207", "rtk440"}},
    ...
    "rtk714": {"character": "括", "keyword": "fasten",
                "expected_part_ids": {"kangxi64", "rtk41"}},
    ...
    "rtk835": {"character": "峠", "keyword": "mountain pass",
                "expected_part_ids": {"rtk50", "rtk51", "rtk830"}},
    ...
    "rtk1367": {"character": "釜", "keyword": "cauldron",
                "expected_part_ids": {"rtk1366", "rtk287"}},
    ...
    "rtk1401": {"character": "院", "keyword": "inst.",
                "expected_part_ids": {"kangxi170", "rtk199"}},
    ...
    "rtk2194": {"character": "璽", "keyword": "imperial seal",
                "expected_part_ids": {"rtk272", "rtk2867"}},
    ...
    "rtk2060": {"character": "翻", "keyword": "flip",
               "expected_part_ids": {"rtk2058", "rtk615"}},
    "rtk2371": {"character": "摺", "keyword": "rubbing",
               "expected_part_ids": {"kangxi64", "rtk616"}},
    ...
    "rtk2908": {"character": "翫", "keyword": "fiddle with",
               "expected_part_ids": {"rtk616", "rtk63"}},
    ...
    "rtk1740": {"character": "南", "keyword": "south",
                "expected_part_ids": {"rtk10", "kangxi12", "kangxi13"}},
    ...
    "rtk846": {"character": "頒", "keyword": "partition",
               "expected_part_ids": {"rtk64", "rtk844"}},
    ...
    "rtk1442": {"character": "羅", "keyword": "gauze",  # was missing 罒 (net radical) entirely — 2026-09-05
               "expected_part_ids": {"kangxi122", "rtk1441"}},
    "rtk1453": {"character": "級", "keyword": "class",
               "expected_part_ids": {"rtk1431", "rtk743"}},
    ...
    "rtk1774": {"character": "緯", "keyword": "horizontal",
               "expected_part_ids": {"kangxi178", "rtk1431"}},
    "rtk1853": {"character": "顔", "keyword": "face",
               "expected_part_ids": {"rtk1852", "rtk64"}},
    ...
    "rtk1914": {"character": "組", "keyword": "association",
               "expected_part_ids": {"rtk1431", "rtk2190"}},
    "rtk1928": {"character": "顕", "keyword": "appear",
               "expected_part_ids": {"prim-upside-down-row", "rtk12", "rtk64"}},
    ...
    "rtk2703": {"character": "紐", "keyword": "string",
               "expected_part_ids": {"rtk1431", "rtk2197"}},
    ...
    "rtk2711": {"character": "絃", "keyword": "catgut",
               "expected_part_ids": {"rtk1431", "rtk1484"}},
    ...
    "rtk2827": {"character": "鯛", "keyword": "sea bream",
               "expected_part_ids": {"rtk183", "rtk339"}},
    ...
    "rtk2840": {"character": "鮒", "keyword": "crucian carp",
               "expected_part_ids": {"rtk1075", "rtk183"}},
    "rtk2841": {"character": "鮨", "keyword": "sushi",
               "expected_part_ids": {"rtk183", "rtk493"}},
    ...
    "rtk2956": {"character": "噸", "keyword": "ton",
               "expected_part_ids": {"rtk11", "rtk1610"}},
    ...
    "rtk1660": {"character": "静", "keyword": "quiet",
               "expected_part_ids": {"rtk1238", "rtk1654"}},
    ...
    "rtk2486": {"character": "蔚", "keyword": "grow plentiful",
               "expected_part_ids": {"prim-mugwort", "rtk1176"}},
    ...
    "rtk1608": {"character": "爽", "keyword": "bracing",
               "expected_part_ids": {"prim-sheaf", "rtk112"}},
    ...
    # 2026-09-25: was pinned to 田 + 亀 + 虫. 亀 is a real phantom — an
    # 11-stroke kanji claimed by a character it is not in — but the first fix
    # that morning threw out the 田 with it, reading cjkvi's ⿰虫⿻日电 as a parts
    # list. ⿻ is an *overlay* operator: it says the two shapes share strokes,
    # not that the visible top box is a 日. Rendered beside 黾 (U+9EFE), the
    # shape 蝿's right side draws, that box is plainly divided by a vertical.
    # 田 it is, plus the hook that descends from it.
    "rtk2725": {"character": "蝿", "keyword": "fly",
               "expected_part_ids": {"rtk14", "rtk556", "rtk75"}},
    ...
    "rtk2488": {"character": "莞", "keyword": "smiling",
               "expected_part_ids": {"prim-mugwort", "rtk199"}},
    ...
    "rtk1130": {"character": "易", "keyword": "easy",
               "expected_part_ids": {"rtk1128", "rtk12"}},
    "rtk1817": {"character": "瘍", "keyword": "swelling",
               "expected_part_ids": {"kangxi104", "rtk1", "rtk1128", "rtk12"}},
    "rtk2292": {"character": "吻", "keyword": "proboscis",
               "expected_part_ids": {"rtk11", "rtk1128"}},
    "rtk2509": {"character": "忽", "keyword": "in a moment",
               "expected_part_ids": {"rtk1128", "rtk639"}},
    "rtk1613": {"character": "辞", "keyword": "resign",
               "expected_part_ids": {"rtk1612", "rtk41"}},
    "rtk1614": {"character": "梓", "keyword": "catalpa tree",
               "expected_part_ids": {"rtk1612", "rtk207"}},
    ...
    "rtk770": {"character": "枝", "keyword": "bough",
               "expected_part_ids": {"rtk207", "rtk768"}},
    "rtk771": {"character": "肢", "keyword": "limb",
               "expected_part_ids": {"rtk13", "rtk768"}},
    "rtk834": {"character": "岐", "keyword": "branch off",
               "expected_part_ids": {"rtk768", "rtk830"}},
    "rtk2312": {"character": "妓", "keyword": "stretch",
               "expected_part_ids": {"rtk102", "rtk768"}},
    "rtk2858": {"character": "艘", "keyword": "counter for small boats",
               "expected_part_ids": {"rtk12", "rtk2012", "rtk768"}},
    "rtk2176": {"character": "醜", "keyword": "ugly",
               "expected_part_ids": {"rtk1534", "rtk2175"}},
    "rtk2177": {"character": "魂", "keyword": "soul",  # was flattening a redundant 二 instead of referencing 云
               "expected_part_ids": {"rtk2175", "rtk2241"}},
    "rtk2178": {"character": "魔", "keyword": "witch",  # was flattening 麻's own parts instead of referencing it
               "expected_part_ids": {"rtk2175", "rtk637"}},
    "rtk2180": {"character": "塊", "keyword": "clod",
               "expected_part_ids": {"rtk161", "rtk2175"}},
    "rtk2489": {"character": "蒐", "keyword": "gather",
               "expected_part_ids": {"prim-mugwort", "rtk2175"}},
    "rtk2932": {"character": "魁", "keyword": "charging ahead of others",
               "expected_part_ids": {"rtk1261", "rtk2175"}},
    "rtk1485": {"character": "畜", "keyword": "livestock",
    ...
    "rtk2614": {"character": "珊", "keyword": "coral",  # was ｜,一,王,亅,冂,冊,廾 -- IDS ⿰王冊 has no 侖 either
               "expected_part_ids": {"rtk1967", "rtk271"}},
